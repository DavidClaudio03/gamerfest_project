...
<template>
    ...
    <div class="mt-20">
        <div class="max-w-7xl mx-auto">
            <div class="most-popular animate__animated animate__fadeIn"
                ...
                <div id="slide" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner" style="border-radius: 25px;">
                        <div class="carousel-item active" data-interval="1800">
                            <img src="/img/slide-1.webp" height="450px" class="d-block w-100 img-fluid" alt="...">
                        </div>
                        <div class="carousel-item" data-interval="1800">
                            <img src="/img/slide-2.webp" height="450px" class="d-block w-100 img-fluid" alt="...">
                        </div>
                        <div class="carousel-item" data-interval="1800">
                            <img src="/img/slide-3.webp" height="450px" class="d-block w-100 img-fluid" alt="...">
                        </div>
                        <div class="carousel-item" data-interval="1800">
                            <img src="/img/slide-4.webp" height="450px" class="d-block w-100 img-fluid" alt="...">
                        </div>
                        <div class="carousel-item" data-interval="1800">
                            <img src="/img/slide-5.webp" height="450px" class="d-block w-100 img-fluid" alt="...">
                        </div>
                        <div class="carousel-item" data-interval="1800">
                            <img src="/img/slide-6.webp" height="450px" class="d-block w-100 img-fluid" alt="...">
                        </div>
                        <div class="carousel-item" data-interval="1800">
                            <img src="/img/slide-7.webp" height="450px" class="d-block w-100 img-fluid" alt="...">
                        </div>
                        <div class="carousel-item" data-interval="1800">
                            <img src="/img/slide-8.webp" height="450px" class="d-block w-100 img-fluid" alt="...">
                        </div>
                        <div class="carousel-item" data-interval="1800">
                            <img src="/img/slide-9.webp" height="450px" class="d-block w-100 img-fluid" alt="...">
                        </div>
                        <div class="carousel-item" data-interval="1800">
                            <img src="/img/slide-10.webp" height="450px" class="d-block w-100 img-fluid" alt="...">
                        </div>
                    </div>
            ...
            <div class="most-popular sponsors" style="background-color: rgba(67, 61, 66, 0.86); margin-top: 40px;">
                <h2 class="section-title">Sponsors del Evento</h2>
                <div class="help-text">
                    Un agradecimiento especial para las personas que confiaron en el proyecto
                </div>
            ...
            <div class="col-lg-4 col-md-12 mb-4 mb-md-0">
                ...
                <br>
                    <a href="https://espe-el.espe.edu.ec/ingenieria-en-software/" class="text-white mx-2" target="_blank">
                        <img src="img/software-logo.png" class="logo" alt="Software Logo"
                            style="max-width: 360px;">
                    </a>
                    <div class="creators list-none">
                        <div><a href="https://tellxmaster.world/" target="_blank" class="text-current no-underline link-hover"><span>tellxmaster</span> <i class="fa-solid fa-dragon"></i></a></div>|
                        <div><a href="https://github.com/joalasco" target="_blank" class="text-current no-underline link-hover"><span>joalasco</span> <i class="fa-solid fa-khanda"></i></a></div>|
                        <div><a href="https://github.com/jordantalahua123" target="_blank" class="text-current no-underline link-hover"><span>jordanth</span> <i class="fab fa-github"></i></a></div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <AlertComponent :color="'#4E9F3D'" :isAlertVisible="isAlertVisible" :title="'Nuevo Juego'" :message="alertMessage" />
</template>
...
.sponsor-container {
    ...
    margin: .5em;
    overflow: hidden;
    transition: color 200ms ease-in, box-shadow 200ms ease-in, border 200ms ease-in;
}
